...
public final class QuotationInvoiceService {
    ...
    public static QuotationResult createQuotation(int customerId,LocalDate validUntil,LocalDate productionDueDate,String notes,List<QuotationLineInput>lines)throws SQLException{JsonObject b=base(customerId,validUntil,productionDueDate,notes,lines);return result("CREATE",b,"quotation",QuotationResult.class);}
    public static QuotationResult createQuotation(int customerId,LocalDate validUntil,LocalDate productionDueDate,String notes,List<QuotationLineInput>lines,boolean applyCustomerDiscount)throws SQLException{JsonObject b=base(customerId,validUntil,productionDueDate,notes,lines);b.addProperty("applyCustomerDiscount",applyCustomerDiscount);return result("CREATE",b,"quotation",QuotationResult.class);}
    public static void issueQuotation(long id)throws SQLException{mutate("ISSUE",id,null);}
    public static QuotationResult updateDraftQuotation(long id,int customerId,LocalDate validUntil,LocalDate productionDueDate,String notes,List<QuotationLineInput>lines)throws SQLException{JsonObject b=base(customerId,validUntil,productionDueDate,notes,lines);b.addProperty("quotationId",id);return result("UPDATE",b,"quotation",QuotationResult.class);}
    public static QuotationResult updateDraftQuotation(long id,int customerId,LocalDate validUntil,LocalDate productionDueDate,String notes,List<QuotationLineInput>lines,boolean applyCustomerDiscount)throws SQLException{JsonObject b=base(customerId,validUntil,productionDueDate,notes,lines);b.addProperty("quotationId",id);b.addProperty("applyCustomerDiscount",applyCustomerDiscount);return result("UPDATE",b,"quotation",QuotationResult.class);}
    ...
    public static void chargeInvoiceToAccount(long id,String reason,String approvalToken,String approvalReason,LanApiClient.ChargeAuthorization authorization)throws SQLException{JsonObject b=new JsonObject();b.addProperty("invoiceId",id);b.addProperty("reason",reason);b.addProperty("approvalToken",approvalToken);b.addProperty("approvalReason",approvalReason);b.add("authorization",GSON.toJsonTree(authorization));mutate("ACCOUNT",null,b);}
    ...
    private static JsonObject base(int customerId,LocalDate until,LocalDate due,String notes,List<QuotationLineInput>lines){JsonObject b=new JsonObject();b.addProperty("customerId",customerId);b.addProperty("validUntil",until==null?null:until.toString());b.addProperty("productionDueDate",due==null?null:due.toString());b.addProperty("notes",notes);b.add("lines",GSON.toJsonTree(lines));return b;}
    ...
    public record QuotationLineInput(Integer productId,String itemName,String sku,int quantity,BigDecimal unitPrice,BigDecimal originalUnitPrice,BigDecimal discountPercent,String deliveryMethod,String notes,String priceOverrideReason,Integer priceOverrideByUserId,String priceOverrideByName,String priceOverrideApprovalToken,CustomLineInput custom){}
    public record CustomLineInput(Long customItemId,Long customVariantId,String variantName,String pricingType,BigDecimal widthValue,BigDecimal lengthValue,String dimensionUnit,BigDecimal areaValue,String areaUnit,BigDecimal areaPrice,String customizationDetails,String orderInstructions,List<PrintAddonInput>printAddons,String itemSize,String itemColor){
        public CustomLineInput(Long customItemId,Long customVariantId,String variantName,String pricingType,BigDecimal widthValue,BigDecimal lengthValue,String dimensionUnit,BigDecimal areaValue,String areaUnit,BigDecimal areaPrice,String customizationDetails,String orderInstructions,List<PrintAddonInput>printAddons){this(customItemId,customVariantId,variantName,pricingType,widthValue,lengthValue,dimensionUnit,areaValue,areaUnit,areaPrice,customizationDetails,orderInstructions,printAddons,null,null);}
    }
