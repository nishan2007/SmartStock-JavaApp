...
public final class ServerQuotationInvoiceDocumentBuilder {
    ...
    private static void appendLetterhead(StringBuilder out, ServerCompanyCustomizationRepository.ReceiptSettings settings, String title) {
    ...
    private static void appendFooterAndSignatures(StringBuilder out, ServerCompanyCustomizationRepository.QuotationInvoicePrintSettings settings) {
        if (!settings.footerNote().isBlank()) {
            appendRule(out);
