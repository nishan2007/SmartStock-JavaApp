...
--
-- Name: smartstock_prune_store_mirror_generations(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.smartstock_prune_store_mirror_generations(p_location_id integer, p_keep_complete integer DEFAULT 2, p_max_delete integer DEFAULT 25) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO ''
    AS $$
DECLARE
...
ALTER TABLE ONLY public.smartstock_store_snapshot_generations
    ADD CONSTRAINT smartstock_store_snapshot_generations_based_on_fkey FOREIGN KEY (based_on_generation_id) REFERENCES public.smartstock_store_snapshot_generations(generation_id) ON DELETE SET NULL;
...
--
-- Name: FUNCTION smartstock_prune_store_mirror_generations(p_location_id integer, p_keep_complete integer, p_max_delete integer); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.smartstock_prune_store_mirror_generations(p_location_id integer, p_keep_complete integer, p_max_delete integer) FROM PUBLIC;
GRANT ALL ON FUNCTION public.smartstock_prune_store_mirror_generations(p_location_id integer, p_keep_complete integer, p_max_delete integer) TO service_role;
...
-- Optional product-group metadata; products remain the sellable inventory authority.
...
INSERT INTO public.permissions(permission_key,permission_name,description,permission_group,permission_subgroup) VALUES('MANAGE_CUSTOMER_DISCOUNTS','Manage Customer Discounts','Allows configuring automatic customer discounts.','Customers','Discounts') ON CONFLICT(permission_key) DO NOTHING;
...
REVOKE ALL ON TABLE public.customer_charge_authorizations FROM PUBLIC;
