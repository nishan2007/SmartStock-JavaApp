...
VALUES
    ('INVENTORY_STOCK_NOTIFICATIONS', 'Inventory Stock Notifications',
     'Allows receiving low-stock and out-of-stock notifications for inventory and custom-order items.', 'Inventory'),
    ('CUSTOM_ORDER_WORK_NOTIFICATIONS', 'Custom Order Work Notifications',
     'Allows receiving operational notifications for due, overdue, ready, unassigned, and balance-due custom orders.', 'Orders'),
    ('CUSTOM_ORDER_EXCEPTION_NOTIFICATIONS', 'Custom Order Exception Notifications',
     'Allows receiving custom-order exception notifications such as recent refunds.', 'Orders'),
    ('SYNC_NOTIFICATIONS', 'Sync Notifications',
     'Allows receiving sync health notifications for offline cloud, failed events, conflicts, and backlogs.', 'Administration')
